...
const PosterSubmission=()=>{
  ...
  <ol>
    ...
    <li>Kindly ensure your paper is formatted s (not exceeding 8 pages written in A4 size).All papers must be submitted online via <a href="https://cmt3.research.microsoft.com/User/Login?ReturnUrl=%2FICICC2024">Microsoft CMT Submission Portal</a>
    </li>
