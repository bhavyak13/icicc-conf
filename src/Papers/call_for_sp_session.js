...
const SpSession=()=>{
    return (
        <div className={style.container}>
          <hr />
            <u><b>Invitation to conduct special session in ICICC 2025</b></u> <br /><br />
            <b className={style.greet}>Dear Sir/ Mam</b>
            <br /><br />
            <p>Greeting from ICICC-2025!<br /><br />

ICICC Conference team invites you to organize the special session in eighth version of International Conference on Innovative Computing and Communications (ICICC-2025), to be held at Shaheed Sukhdev College of Business Studies (University of Delhi), Sector 16, Rohini, Delhi - 110089, India during 14-15th February 2025 of your research domain. We are diligently working to bring some of the most knowledgeable researchers from all over the world along with the leaders from the industry to explore the important topics of research. The two day conference will include workshop, technical sessions and keynotes on cutting edge technologies related to our industry. The URL for the conference: <a href="">icicc-conf.com</a>. International Conference on Innovative Computing and Communication (ICICC) is organised with the objective of bringing together innovative scientists, professors, research scholars, students and industrial experts in the field of Computing and Communication to a common forum. The primary goal of the conference is to promote the exchange of innovative scientific information between researchers, developers, engineers, students, and practitioners. Another goal is to promote the transformation of fundamental research into institutional and industrialized research and to convert applied exploration into real time application. Kindly increase the value of the conference by being part of this conference as a session chair and heading your own session in this esteemed conference. We are aware about your networking skills and of having an eye to identify quality research papers.</p>
...
<li> Special discount for your personal paper if above conditions are met. (If minimum number of papers get registered in your session)</li>
<li> Extra weightage and support will be provided for your session extended paper in SCI/ Scopus Journal.</li>
...
<b>ICICC-2025</b></p>
<Button variant="primary" > <a href={require("../Downloads/docs/Session_Proposal_Template.docx")} style={{color:"white",textDecoration:"none"}}>Session Proposal Template</a></Button>
